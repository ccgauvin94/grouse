...
internal object IntegrityCheckingUniffiLib {
    ...
    external fun uniffi_grouse_core_checksum_method_core_connect_resume(
    ): Int
...
internal object UniffiLib {
    ...
    external fun uniffi_grouse_core_fn_method_core_connect_resume(`ptr`: Long,`config`: RustBuffer.ByValue,`sessionId`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    external fun uniffi_grouse_core_fn_method_grouseunstable_session_extensions_remove(`ptr`: Long,`sessionId`: RustBuffer.ByValue,`extensionKey`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    external fun uniffi_grouse_core_fn_method_grouseunstable_set_extension_enabled(`ptr`: Long,`configKey`: RustBuffer.ByValue,`enabled`: Byte,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
...
public interface CoreInterface {
     ...
     */
    fun `connectResume`(`config`: ServerConfig, `sessionId`: kotlin.String)
...
open class Core: Disposable, AutoCloseable, CoreInterface
{
     ...
     * pre-bind) so the cold chat still paints instantly and a fresh cache
     * skips the wire replay — identical fast path, minus the orphan.
     */override fun `connectResume`(`config`: ServerConfig, `sessionId`: kotlin.String)
        = 
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_grouse_core_fn_method_core_connect_resume(
        it,
...
public interface GrouseUnstableInterface {
     ...
     */
    fun `sessionExtensionsRemove`(`sessionId`: kotlin.String, `extensionKey`: kotlin.String)
     ...
     * new enabled state.
     */
    fun `setExtensionEnabled`(`configKey`: kotlin.String, `enabled`: kotlin.Boolean)
...
open class GrouseUnstable: Disposable, AutoCloseable, GrouseUnstableInterface
{
     ...
     * `extensionKey` and now rejects the old shape outright.
     * The paired add re-lists (desktop behavior).
     */override fun `sessionExtensionsRemove`(`sessionId`: kotlin.String, `extensionKey`: kotlin.String)
        = 
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_grouse_core_fn_method_grouseunstable_session_extensions_remove(
        ...
        FfiConverterString.lower(`sessionId`),
        FfiConverterString.lower(`extensionKey`),_status)
}
    }
     ...
     * `configKey` and rejects the old shape). Re-lists so the UI reflects the
     * new enabled state.
     */override fun `setExtensionEnabled`(`configKey`: kotlin.String, `enabled`: kotlin.Boolean)
        = 
    callWithHandle {
    uniffiRustCall() { _status ->
